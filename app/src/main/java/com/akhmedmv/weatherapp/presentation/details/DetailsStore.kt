...
import com.akhmedmv.weatherapp.domain.usecase.ChangeFavouriteStateUseCase
import com.akhmedmv.weatherapp.domain.usecase.GetForecastUseCase
import com.akhmedmv.weatherapp.domain.usecase.ObserveFavouriteStateUseCase
import com.akhmedmv.weatherapp.presentation.details.DetailsStore.Intent
import com.akhmedmv.weatherapp.presentation.details.DetailsStore.Label
import com.akhmedmv.weatherapp.presentation.details.DetailsStore.State
...
internal class DetailsStoreFactory @Inject constructor(
    ...
    private sealed interface Action {
        ...
        data class ForecastLoaded(val loaded: Forecast) : Action
    ...
    private sealed interface Msg {
        ...
        data class ForecastLoaded(val loaded: Forecast) : Msg
        ...
        fun executeAction(action: Action, getState: () -> State) {
            ...
            when (action) {
                ...
                is Action.ForecastLoaded -> {
                    dispatch(Msg.ForecastLoaded(action.loaded))
                }
    ...
    private object ReducerImpl : Reducer<State, Msg> {
        override fun State.reduce(msg: Msg): State = when (msg) {
            ...
            is Msg.ForecastLoaded -> {
                copy(forecastState = State.ForecastState.Loaded(msg.loaded))
            }
